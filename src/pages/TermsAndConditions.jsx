    ...
    <div className="bg-white">
      ...
      <section className="pb-20">
        <div className="mx-auto px-6 md:px-16 lg:px-32 max-w-7xl">
          {/* Section 1 */}
          <h2 className="text-lg font-semibold text-black mb-2 text-left">1. Liability</h2>
          ...
          {/* Section 2 */}
          <h2 className="text-lg font-semibold text-black mb-2 text-left">2. Data Protection and Privacy</h2>
          <p className="text-gray-700 mb-6 text-sm md:text-base leading-relaxed text-justify">
          ...
          {/* Section 3 */}
          <h2 className="text-lg font-semibold text-black mb-2 text-left">3. Changes to the Terms</h2>
          <p className="text-gray-700 mb-6 text-sm md:text-base leading-relaxed text-justify">
          ...
          {/* Section 4 */}
          <h2 className="text-lg font-semibold text-black mb-2 text-left">4. Governing Law and Jurisdiction</h2>
          <p className="text-gray-700 mb-6 text-sm md:text-base leading-relaxed text-justify">
