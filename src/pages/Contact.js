                       ...
                       <div className="text-center">
                         ...
                         <div className="text-gray-600">
                           <a 
                             ...
                             className="text-cyan-600 hover:text-cyan-700 font-medium text-sm md:text-lg transition-colors duration-300 break-all"
                           >
                       ...
                       <div className="text-center">
                         ...
                         <div className="text-gray-600">
                           <a 
                             ...
                             className="text-cyan-600 hover:text-cyan-700 font-bold text-lg md:text-2xl transition-colors duration-300"
                           >
                             0740 7612 398
                           </a>
                           <div className="mt-2 text-sm md:text-lg text-gray-500">Available 24/7</div>
                         </div>
                       </div>
                     </div>
                   </div>
